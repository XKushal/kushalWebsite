...
seo_common = {
    ...
    "image": urljoin(url, "/assets/strengthlens.svg"),
}
...
custom_pages = [
    {
        ...
        "seo": {
            **seo_common,
            ...
            "title": f"{title_name} | Wins",
            "description": f"{title_name}'s wins and milestones",
            "image": urljoin(url, "/assets/strengthlens.svg"),
        },
    },
    {
        ...
        "seo": {
            **seo_common,
            ...
            "title": f"{title_name} | Toolbox",
            "description": f"{title_name}'s stack turned into a tiny toolbox game",
            "image": urljoin(url, "/assets/strengthlens.svg"),
        },
    },
]
